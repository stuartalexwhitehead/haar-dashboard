...
class DeviceTypes extends React.Component {
  ...
  getTable = () => {
    ...
    const hasDeviceTypes = deviceTypes !== null && deviceTypes.length;
    const columns = {
      name: 'Name',
      developer: 'Developer',
      deviceClass: 'Device Class',
    ...
    if (hasDeviceTypes) {
      const data = deviceTypes.map(deviceType => {
        const actions = (
          <span>
            <Button to={`/dashboard/device-types/${deviceType._id}/edit`} size="small">Edit</Button>
          </span>
        );
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button to="/dashboard/device-types/add">
        ...
        :
          <div>
            <p>There aren’t any device types yet.</p>
            <Button to="/dashboard/device-types/add">Add a device type</Button>
          </div>
        }
      </div>
    );
