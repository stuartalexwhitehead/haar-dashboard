...
class Users extends React.Component {
  ...
  getTable = () => {
    const { users, me, filter } = this.props;
    const usersExistInData = users !== null && users.length;
    const filterExists = users !== null && filter !== null;
    const hasUsers = usersExistInData || filterExists;
  ...
  render() {
    ...
    return (
      <div className="users">
        ...
        <Button to="/dashboard/users/add" className="users__add">
          <span className="icon--plus users__add-icon">
          Add User</span>
        </Button>
        ...
        :
          <div>
            <p className="users__none">There aren’t any users yet.</p>
          </div>
        }
      </div>
    );
