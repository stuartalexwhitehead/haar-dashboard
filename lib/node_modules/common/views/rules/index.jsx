...
class Rules extends React.Component {
  ...
  getTable = () => {
    ...
    const hasRules = rules !== null && rules.length;
      ...
      const data = rules.map(rule => {
        const actions = (
          <span>
            ...
            :
              <Button size="small" onClick={() => this.enableRule(rule)}>Enable</Button>
            }
            <Button
              size="small"
              theme="danger"
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button to={`/dashboard/devices/${params.device}/rules/add`}>
          <span className="icon--plus">Add Rule</span>
        </Button>
        ...
        :
          <div>
            <p>There aren’t any rules yet.</p>
            <Button to={`/dashboard/devices/${params.device}/rules/add`}>Add a rule</Button>
          </div>
        }
      </div>
    );
