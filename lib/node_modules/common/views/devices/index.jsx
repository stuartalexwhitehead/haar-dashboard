        ...
        const actions = (
          <span>
            {device.deviceType.deviceClass === 'input' ?
              <Button to={`/dashboard/devices/${device._id}/data`} size="small">Data</Button>
            : null}
            {device.deviceType.deviceClass === 'output' ?
              <Button to={`/dashboard/devices/${device._id}/rules`} size="small">Rules</Button>
            : null}

            <Button to={`/dashboard/devices/${device._id}/edit`} size="small">Edit</Button>
            <Button
              size="small"
              theme="danger"
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button to="/dashboard/devices/add"><span className="icon--plus">Add Device</span></Button>
        ...
        :
          <div>
            <p>There aren’t any devices yet.</p>
            <Button to="/dashboard/devices/add">Add a device</Button>
          </div>
        }
      </div>
    );
